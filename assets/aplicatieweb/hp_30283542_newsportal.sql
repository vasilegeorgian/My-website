...
--
-- Bază de date: `hp_30283542_newsportal`
--
...
(1, 'admin', '$2y$12$XOVsG7GzLQvSvGhDWJKB2eb2W1L9P1NC87MaRpZ.gPmlWSwvzHTtS', 'george.crysty97@gmail.com', 1, '2021-02-11 15:51:00', '0000-00-00 00:00:00');
...
--
-- Structură tabel pentru tabel `tblcomments`
--
...
--
-- Eliminarea datelor din tabel `tblcomments`
--

INSERT INTO `tblcomments` (`id`, `postId`, `name`, `email`, `comment`, `postingDate`, `status`) VALUES
(4, '10', 'Vasile Georgian', 'george.crysty37@yahoo.com', 'Salut', '2021-02-11 18:15:39', 0),
(5, '7', 'Emi', '1234@yahoo.com', 'Salut', '2021-02-11 19:55:46', 0);

-- --------------------------------------------------------

--
-- Structură tabel pentru tabel `tblpages`
--
...
--
-- Eliminarea datelor din tabel `tblpages`
--
...
(2, 'contactus', 'Contact Details', '<p><br></p><p><b>Address :&nbsp; </b>Vaslui</p><p><b>Phone Number : </b>+0767345004</p><p><b>Email -id : </b>george.crysty97@gmail.com</p>', '2018-06-30 18:01:36', '2021-02-11 19:22:53');

-- --------------------------------------------------------

--
-- Structură tabel pentru tabel `tblposts`
--
...
--
-- Eliminarea datelor din tabel `tblposts`
--
...
--
-- Structură tabel pentru tabel `tblsubcategory`
--
...
--
-- Eliminarea datelor din tabel `tblsubcategory`
--
...
(1, 'george', 'george.crysty97@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '2021-02-11 20:36:32'),
(2, '123', '123@yahoo.com', '202cb962ac59075b964b07152d234b70', '2021-02-11 20:37:50'),
(3, 'georgevs3', 'george.crysty37@yahoo.com', '202cb962ac59075b964b07152d234b70', '2021-02-11 21:16:18'),
(4, 'hahaha', 'dada@gmail.com', '101a6ec9f938885df0a44f20458d2eb4', '2021-11-15 07:35:54');
...
--
-- Indexuri pentru tabele `tblcomments`
--
ALTER TABLE `tblcomments`
  ADD PRIMARY KEY (`id`);

--
-- Indexuri pentru tabele `tblpages`
--
ALTER TABLE `tblpages`
  ADD PRIMARY KEY (`id`);

--
-- Indexuri pentru tabele `tblposts`
--
ALTER TABLE `tblposts`
  ADD PRIMARY KEY (`id`);

--
-- Indexuri pentru tabele `tblsubcategory`
--
...
--
-- AUTO_INCREMENT pentru tabele `tblcomments`
--
ALTER TABLE `tblcomments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pentru tabele `tblpages`
--
ALTER TABLE `tblpages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pentru tabele `tblposts`
--
ALTER TABLE `tblposts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pentru tabele `tblsubcategory`
--
ALTER TABLE `tblsubcategory`
